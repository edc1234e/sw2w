...
const UUIDS = [
    '28e9507c-d733-49e3-a29a-d64c246b4b1e',  
    'd6502882-883c-4b87-9711-eba582bfdb24',  
    'e3f22269-5f07-4ae6-91ee-bd9e7aa3b058', 
    '94c75834-9051-461c-8c34-47e3442e88ea',
    '1cfbe202-df5c-4143-92cb-abf74b66789a',
    '91df4356-6680-4be8-85e2-06914f649c84',
];

// 订阅地址后缀（这里需要修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'cft4rft5';

// XHTTP 路径（这里需要修改一下，可以随便输入一些字母或数字）
const XPATH = 's11sdfgy7径';
